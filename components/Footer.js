...
const Footer = ({ footerData }) => {
  ...
  return (
    <footer className='bg-darkblue lg:bg-transparent lg:bg-footer lg:bg-no-repeat lg:bg-left-bottom relative lg:min-h-[738px] pt-12 lg:pt-0' id='foot'>
      <motion.div
      ...
      >
        ...
        >
          <Image src={truckImg} width={430} height={210} alt="truck2" />
        </motion.div>
        {/* hill image */}
        ...
        >
          ...
          <div className='flex-1 text-white border-l-[10px] border-accent py-4 lg:mt-24'>
            <p className='max-w-[330px] text-[20px] leading-[30px] ml-[40px] font-slab'>
              {text}
            </p>
          </div>
          {/* form */}
          <form className='w-full max-w-[550px] bg-white flex-1 rounded-[10px] lg:order-2 flex flex-col px-[35px] lg:px-[75px] py-[25px] lg:py-[52px] space-y-[40px] drop-shadow-primary'>
            ...
            <button className='btn self-start hover:bg-accent-hover transition font-slab font-bold'>
              {form.btnText}
        ...
        >
          {/* logo */}
          <div className='mb-6 mx-auto lg:mb-0 lg:mx-0 pl-[40px]'>
            <Link href={'/'}>
              <a>
                <Image src={logo} width={170} height={41} alt="logo2" />
              </a>
            </Link>
          </div>
          {/* links */}
          <ul className='flex flex-col items-center lg:flex-row gap-y-4 lg:gap-y-0 gap-x-[100px] text-center'>
            {links.map((item, idx) => {
              return (
                ...
                >
                  <Link href={item.href}>
                  <a className='font-slab font-medium capitalize'>
                  {item.name}
                  </a>
                  </Link>
                </li>
